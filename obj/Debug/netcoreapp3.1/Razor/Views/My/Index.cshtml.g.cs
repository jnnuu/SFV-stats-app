#pragma checksum "C:\Users\Jonni\source\repos\SFV-stats-app-master\FighterApp\Views\My\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c04e7a64c8250fc66b72a9394838aa727246e314"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c04e7a64c8250fc66b72a9394838aa727246e314", @"/Views/My/Index.cshtml")]
...
#nullable disable
            ...
            DefineSection("head", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c04e7a64c8250fc66b72a9394838aa727246e3144016", async() => {
                }
                );
...
#nullable disable
            EndWriteAttribute();
            WriteLiteral(" class=\"InvisibleText\" onClick=\"AddHeroToGame(this.id)\"><img");
            BeginWriteAttribute("src", " src=\"", 1002, "\"", 1061, 1);
#nullable restore
#line 29 "C:\Users\Jonni\source\repos\SFV-stats-app-master\FighterApp\Views\My\Index.cshtml"
WriteAttributeValue("", 1008, getFighterAvatar(Enum.GetName(typeof(Fighter_id),i)), 1008, 53, false);
...
<script>
    ...
    function AddHeroToGame(fighter_Id)
    {
        ...
        if (ids[0] == -1 && wasNew == true) {
            ids[0] = fighter_Id;
            $(""#""+fighter_Id).toggleClass(""clicked"");
            $("".p1"").append(GetFighterName(fight");
            WriteLiteral(@"er_Id));
    ...
    function PostGame()
    {
        ...
        $.ajax(url.replace(");
            WriteLiteral("\"_1\", ids[0]).replace(\"_2\", ids[1]), {type: \'POST\'} ).done(function() {console.log(\"i did it:\" + ids[0] + \" \" + ids[1]);});\r\n        ids = [];\r\n    }\r\n    function GetFighterName(id)\r\n    {\r\n        return $(\"#\"+id).text();\r\n    }\r\n</script>\r\n\r\n");
        }
